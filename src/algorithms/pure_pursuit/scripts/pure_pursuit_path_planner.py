...
LOOKAHEAD_DISTANCE_STRAIGHT = 2.0 # meters   # 6.5
...
VELOCITY_STRAIGHT =1.50 # m/s                # 6.5
...
WP_TURN_WINDOW_MIN = 1.5                          # 5.5
WP_TURN_WINDOW_MAX = 2.5                          # 6.0
...
def callback(data):
    ...
    print "Average x wrt car:", avg_x_wrt_car
...
if __name__ == '__main__':
    ...
    rospy.Subscriber('/move_base/TrajectoryPlannerROS/local_plan', Path, global_plan_callback, queue_size=1)
    rospy.spin()
